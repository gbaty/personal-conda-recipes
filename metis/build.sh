...
# Change ARCH in config file
LINETOMODIFY=`grep "#define IDXTYPEWIDTH" include/metis.h`
sed -i "s|$LINETOMODIFY|#define IDXTYPEWIDTH $ARCH|" include/metis.h

LINETOMODIFY=`grep "#define REALTYPEWIDTH" include/metis.h`
sed -i "s|$LINETOMODIFY|#define REALTYPEWIDTH $ARCH|" include/metis.h
